...
public class _6KanboardAddNewColumnTest {
    ...
    public void testAddNewColumn() {
        ...
        try {
            ...
            titleField.sendKeys("New Column 3");
            ...
            wait = new WebDriverWait(driver, Duration.ofSeconds(10));
            WebElement showText = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//td[contains(normalize-space(.),'New Column 3')]")));
